...
vim.api.nvim_set_keymap('i', 'jj', '<Esc>', { desc = 'Exit insert mode', noremap = true, silent = true })
      ...
      { 'nvim-telescope/telescope-ui-select.nvim' },
      {
        ...
        config = function()
          require('auto-session').setup {
            ...
            auto_session_suppress_dirs = { 'C:\\', 'C:\\Users\\fried', '~/', '~/Downloads', '/' },
          ...
          vim.keymap.set('n', '<leader>se', require('auto-session.session-lens').search_session, {
            desc = '[S]earch recent S[E]ssions',
            noremap = true,
          })
        end,
      },
